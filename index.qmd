...
```{python}
#| echo: false
df = pd.read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vS3PhQMmp5GAlPNAY3q3I9gx_tVuLPRFUMNK2-d3B2ux9ur-pQvnAfwXBr3uJEJpAZvj3aa2MV-uaWP/pub?gid=0&single=true&output=csv", encoding="utf-8" )[["Gruppe", "Egenvekt", "Påsatt vekt","Forholdstall", "Dato"]]
...
chosen_cols = ['Gruppe', 'Egenvekt', 'Påsatt vekt', 'Forholdstall']

df2 = (
    df.assign(**{col:g add_g(df[col]) for col in cols_with_g})[chosen_cols]
